...
{$endif}
  ...
  var
    i			: integer;
    Pal			: TMaxLogPalette;
    asdk_tmp :  TPaletteEntry;
  begin
    Pal.palVersion := $0300;
    Pal.palNumEntries := 256;
    for i := 0 to 255 do
    begin
      asdk_tmp := Pal.palPalEntry[i];
      asdk_tmp.peRed := i;
      asdk_tmp.peGreen := i;
      asdk_tmp.peBlue  := i;
      asdk_tmp.peFlags := PC_NOCOLLAPSE;
      Pal.palPalEntry[i] := asdk_tmp;
    end;
  ...
  begin
    ...
    begin
      asdk_tmp := Pal.palPalEntry[i];
      asdk_tmp.peRed := Values[i];
      asdk_tmp.peGreen := Values[i];
      asdk_tmp.peBlue  := Values[i];
      asdk_tmp.peFlags := PC_NOCOLLAPSE;
      Pal.palPalEntry[i] := asdk_tmp;
    end;
    Result := CreatePalette(pLogPalette(@Pal)^);
